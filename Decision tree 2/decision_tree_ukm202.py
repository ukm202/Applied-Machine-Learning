...
#                         the best index list of left and class_labels_list_after_split
        ...
        class_labels_list_after_split = values_greater_than_theta_list + values_less_than_theta_list
...
#         return the max info gain, theata,the best left list,the best right list and class label after split
    return max_info_gain, theta, best_index_on_left_list, best_index_on_right_list, class_labels_list_after_split
